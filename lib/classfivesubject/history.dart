...
class ClassFiveHistory extends StatefulWidget {
  final String title;

  final bagcolor = const Color(0xFF192A56);

  @override
  ClassFiveHistory(this.title);
  _ClassFiveHistoryState createState() => _ClassFiveHistoryState();
}

class _ClassFiveHistoryState extends State<ClassFiveHistory> {
  @override
  void initState() {
    super.initState();
  }
          ...
          Center(
            child: MaterialButton(
              ...
              onPressed: (){
                Navigator.push(
                  context,
                  MaterialPageRoute( builder: (context) => ClassFiveHistory('Change Password   ')),
                );
              },
            ),
          ),
