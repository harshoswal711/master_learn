...
class ClassFiveMarathi extends StatefulWidget {
  final String title;

  final bagcolor = const Color(0xFF192A56);

  @override
  ClassFiveMarathi(this.title);
  _ClassFiveMarathiState createState() => _ClassFiveMarathiState();
}

class _ClassFiveMarathiState extends State<ClassFiveMarathi> {
  @override
  void initState() {
    super.initState();
  }
          ...
          Center(
            child: MaterialButton(
              ...
              onPressed: (){
                Navigator.push(
                  context,
                  MaterialPageRoute( builder: (context) => ClassFiveMarathi('Change Password   ')),
                );
              },
            ),
          ),
