...
class ClassFiveGeo extends StatefulWidget {
  final String title;

  final bagcolor = const Color(0xFF192A56);

  @override
  ClassFiveGeo(this.title);
  _ClassFiveGeoState createState() => _ClassFiveGeoState();
}

class _ClassFiveGeoState extends State<ClassFiveGeo> {
  @override
  void initState() {
    super.initState();
  }
          ...
          Center(
            child: MaterialButton(
              ...
              onPressed: (){
                Navigator.push(
                  context,
                  MaterialPageRoute( builder: (context) => ClassFiveGeo('Change Password   ')),
                );
              },
            ),
          ),
