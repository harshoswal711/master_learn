...
class ClassFiveHindi extends StatefulWidget {
  final String title;

  final bagcolor = const Color(0xFF192A56);

  @override
  ClassFiveHindi(this.title);
  _ClassFiveHindiState createState() => _ClassFiveHindiState();
}

class _ClassFiveHindiState extends State<ClassFiveHindi> {
  @override
  void initState() {
    super.initState();
  }
          ...
          Center(
            child: MaterialButton(
              ...
              onPressed: (){
                Navigator.push(
                  context,
                  MaterialPageRoute( builder: (context) => ClassFiveHindi('Change Password   ')),
                );
              },
            ),
          ),
