...
class ClassFiveScience extends StatefulWidget {
  final String title;

  final bagcolor = const Color(0xFF192A56);

  @override
  ClassFiveScience(this.title);
  _ClassFiveScienceState createState() => _ClassFiveScienceState();
}

class _ClassFiveScienceState extends State<ClassFiveScience> {
  @override
  void initState() {
    super.initState();
  }
          ...
          Center(
            child: MaterialButton(
              ...
              onPressed: (){
                Navigator.push(
                  context,
                  MaterialPageRoute( builder: (context) => ClassFiveScience('Change Password   ')),
                );
              },
            ),
          ),
